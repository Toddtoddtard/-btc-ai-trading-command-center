...
required = {
    "historical_specialist_backtest_v7.py": ["ELIGIBLE", "detect_regime", "directional_calls", "evaluated_windows", "overall_council", "holdout"],
    ...
    ".github/workflows/historical-specialist-v7.yml": ["historical_specialist_backtest_v7.py", "evaluated_windows", "HISTORICAL_YEARS", "version') == 9"],
}
