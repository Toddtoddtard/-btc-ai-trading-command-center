...
required = {
    "historical_specialist_backtest_v7.py": ["ELIGIBLE", "detect_regime", "directional_calls", "evaluated_windows"],
    ...
    ".github/workflows/historical-specialist-v7.yml": ["historical_specialist_backtest_v7.py", "evaluated_windows"],
}
