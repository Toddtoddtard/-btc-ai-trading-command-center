...
def live_dashboard():
    ...
    with tab_paper:
        ...
        st.caption(
            ...
            "Kalshi contract price; final LOCK calls may enter above 75%. "
            "SCALP requires a projected 20% gross return on entry cost, has no "
            "maximum-spread filter, stops after a "
